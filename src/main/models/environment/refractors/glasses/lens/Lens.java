...
public abstract class Lens extends Refractor {
     ...
     protected final float apertureDiameter;
     ...
     */
     public Lens(Vector2 position, Polygon lensShape, float radiusOfCurvature, float centerThickness, float apertureDiameter, float arcAngle, float rotation) {
          super(
               position,
     ...
     /**
          ...
          @param arcAngle the angle of the arcs forming the faces of the lens (custom or generated by len's own calculateArcAngle() method)
     */
     public Lens(float x, float y, Polygon lensShape, float radiusOfCurvature, float centerThickness, float apertureDiameter, float arcAngle, float rotation) {
     ...
     public Vector2 getLeftFaceCenterOfCurvature() {
          ...
          // Center of curvature lies on the opposite direction of the face
